/*  This program will be used to help build an understanding of 
 *  
 *
*/
...
int main()
{
    ...
    //setup for depth and stencil test
    ...
    //set up the vertices for a plane
    float planeVertices[] = {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //no transformations for the floor
        ...
        //move the first object and draw
        model = glm::translate(model, glm::vec3(-1.0f, 0.0f, -1.0f));
        shader.setMat4("model", model);
        glDrawArrays(GL_TRIANGLES, 0, 36);
        model = glm::mat4();
        //move the second object and draw
        ...
        shaderSingleColor.setFloat("time", sin(currentFrame));
